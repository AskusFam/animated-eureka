  ...
  return (
    <main className="workspace-shell">
      ...
      <div className="workspace-grid">
        <section className="workspace-card"><div className="card-kicker">RallyUp’s next move</div><h2>Align the group before the details pile up.</h2><p>RallyUp can collect private preferences, compare options, and bring the group a short recommendation when a decision is ready.</p><div className="workspace-actions"><a className="button" href={`/onboarding?phone=${encodeURIComponent(trip.participants.find((participant) => participant.role === "organizer")?.phoneNumber ?? "")}&tripId=${trip.id}`}>Set up your profile</a><button className="button secondary-button" type="button">Create review page</button></div></section>
